...
![](img/4b7dc350eef1fda2a79b192b8e103284.png)
...
![](img/66de5d71a530c22d35ade2ef8b70d1e2.png)
...
然而，当前人工智能技术的几个关键方面[将不会达到预期](https://www.technologyreview.com/s/603945/is-artificial-intelligence-stuck-in-a-rut/ )，并将引起一些投资者的反弹。
...
是的，[认知架构](https://medium.com/p/ea18127a4d1d/edit)通常涵盖了自主代理的全部需求，包括输入、输出、焦点选择&记忆、学习、推理、目标、元认知。
...
狭义人工智能，根据定义，是为解决特定问题而优化的。我不知道有任何方法可以将狭义人工智能结合起来，以概括它们的认知技能——它们没有兼容的架构或知识表示。此外，它们本质上并不是为了提供智能所需的全面[集成核心功能](https://medium.com/intuitionmachine/agi-checklist-30297a4f5c1f )而设计的。
...
![](img/1b126bef0dba8f6ae977f02dacb51125.png)
...
***在你与亚当福特*** ***的*** [***访谈中，你说“个人助理”很可能是 AGI 的最初形式，随着技术的进步，它将“做得越来越多”。出于需要，目前大多数“虚拟代理”都在回路中使用人类。你认为人类在 AGI 系统的工作中(在商业解决方案中)有作用吗？***](https://youtu.be/4W_vtlSjNk0)
...
![](img/8e15d9065c53febda929b46ba4b57fe5.png)

[https://commons.wikimedia.org](https://commons.wikimedia.org)

诺姆·乔姆斯基认为我们无法创造出理解语言的机器，因为“我们没有人类语言如何运作的方程式”。你似乎不同意，乔姆斯基缺少什么？

我们不能建造飞行器，因为我们没有鸟类飞行的方程式。也许他不理解'[理解](https://chatbotslife.com/understanding-understanding-9dcc15759b5b )'(抱歉这么刻薄，但这确实是一个糟糕的论点)。
...
首先，我不认为“方程式”是看待编程的恰当方式。有时术语[非算法](http://www.thefreedictionary.com/algorithmic)被用来描述复杂的计算。
...
您沿着两个轴进行度量:范围(这里粗略地概括了一下[)和能力(它能够处理的复杂程度)。](https://medium.com/intuitionmachine/agi-checklist-30297a4f5c1f )
...
![](img/2aab0f6d7921b1b908d8ac64d7826ac5.png)
